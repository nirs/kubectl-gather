...
//	Multiple kubeconfigs  filename          current-context from file
//
...
// Context is passed to child processes as --context.
package kubeconfig
...
// directory and extension). No merging or renaming is done.
